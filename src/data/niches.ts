...
export const NICHES: Niche[] = [
  // ── Education ────────────────────────────────────────────────
  {
    ...
    tagline: "Build complete lesson plans and curricula in seconds, not weeks.",
    metaDescription: "Create structured courses, lesson plans, and curricula instantly with Syllabi's AI course generator for teachers. Modules, quizzes, pacing schedules included.",
    blurb: "Stop spending weekends planning lessons from scratch. Syllabi generates complete curricula with modules, lessons, quizzes, and pacing schedules tailored for K-12 and higher education. Export to PDF or Notion and start teaching immediately.",
    ...
    faqs: [
      { question: "Can I customize the generated curriculum for my grade level?", answer: "Yes. When generating a course, you specify the target audience (e.g., 'Grade 8 students' or 'AP History class'). Syllabi tailors the depth, vocabulary, and pacing to match." },
    ...
    keywords: ["course generator for teachers", "AI lesson plan generator", "curriculum builder for educators", "teacher course creator"],
    emoji: "📚",
    category: "education",
  },
  {
    ...
    keywords: ["syllabus generator for professors", "university course builder", "academic course generator AI", "higher education curriculum tool"],
    emoji: "🎓",
    category: "education",
  },
  {
    ...
    tagline: "Create structured, engaging curricula for your child — no teaching degree required.",
    metaDescription: "Homeschool curriculum made easy. Syllabi's AI generates complete courses with lessons, quizzes, and pacing schedules customized for your child's learning level.",
    blurb: "Planning a full year of homeschool curriculum is overwhelming. Syllabi lets you generate age-appropriate, structured courses on any subject — from elementary math to high school biology — with built-in quizzes and weekly pacing schedules.",
    useCases: ["Full-year subject curricula", "Unit studies on specific topics", "Multi-age group lesson planning", "State requirement alignment"],
    faqs: [
    ...
    keywords: ["homeschool curriculum generator", "AI homeschool planner", "homeschool course builder", "homeschool lesson plan generator"],
    emoji: "🏠",
    category: "education",
  },
  {
    ...
    metaDescription: "Create professional tutoring curricula with Syllabi's AI. Generate session plans, practice quizzes, and progress milestones for any subject.",
    ...
    useCases: ["Multi-session tutoring programs", "Test prep curricula (SAT, ACT, GRE)", "Skill-gap remediation plans", "Summer learning programs"],
    faqs: [
      ...
      { question: "How can I share courses with my students' parents?", answer: "Export to PDF for a professional-looking program overview, or use the shareable link feature (Pro Max) so parents can view the full curriculum online." },
    ...
    keywords: ["tutoring curriculum generator", "AI tutor planner", "tutoring program builder", "tutor course creator"],
    emoji: "✏️",
    category: "education",
  },
  // ── Corporate / Professional ─────────────────────────────────
  {
    ...
    metaDescription: "Generate corporate training courses with AI. Create onboarding programs, compliance training, and professional development curricula in minutes with Syllabi.",
    ...
    faqs: [
      { question: "Can I align courses with our company's competency framework?", answer: "Yes. Add your specific context and competency requirements in the course form, and Syllabi will tailor the curriculum to match your organizational goals." },
  ...
  },
  {
    ...
    faqs: [
      { question: "How quickly can I create a full onboarding program?", answer: "Under 60 seconds. Enter your role requirements and company context, and Syllabi generates a multi-week onboarding curriculum with modules, lessons, and checkpoints." },
  ...
  // ── Technology ───────────────────────────────────────────────
  {
    ...
    metaDescription: "Create Python programming courses with AI. Build structured curricula for beginners to advanced developers with modules, coding exercises, and quizzes.",
    ...
    useCases: ["Python bootcamp curricula", "Data science learning paths", "Django/Flask web development courses", "Python for non-programmers"],
    faqs: [
      ...
      { question: "Can I create courses for complete beginners?", answer: "Yes. Specify 'complete beginners with no programming experience' as your audience, and the AI adjusts the curriculum to start with fundamentals like variables, loops, and functions." },
      { question: "What about advanced topics like ML or data engineering?", answer: "Syllabi handles any complexity level. Request courses on machine learning, deep learning, data pipelines, or any Python specialization and get a structured, progressive curriculum." },
    ],
    keywords: ["Python course generator", "AI programming course builder", "Python curriculum creator", "coding course generator"],
    emoji: "🐍",
    category: "technology",
  },
  {
    ...
    metaDescription: "Create web development courses with AI. Generate structured curricula for HTML, CSS, JavaScript, React, Next.js, and full-stack development.",
    ...
    useCases: ["Full-stack bootcamp curricula", "React/Next.js workshop outlines", "Frontend fundamentals courses", "API development training"],
    faqs: [
      { question: "Can I create framework-specific courses?", answer: "Yes. Request courses specifically for React, Vue, Angular, Next.js, Node.js, or any framework. Syllabi generates curricula that follow each framework's learning curve." },
      ...
      { question: "Can I generate a full bootcamp curriculum?", answer: "Yes. Set the course length to 'comprehensive' and Syllabi will generate a multi-month bootcamp curriculum with progressive modules from basics through advanced topics." },
    ],
    keywords: ["web development course generator", "coding bootcamp curriculum builder", "JavaScript course creator", "full-stack course generator"],
    emoji: "💻",
    category: "technology",
  },
  {
    ...
    metaDescription: "Generate data science courses with AI. Create curricula covering statistics, Python, machine learning, and deep learning with structured modules and assessments.",
    ...
    faqs: [
      ...
      { question: "Does it cover tools like TensorFlow or PyTorch?", answer: "Absolutely. Request courses focused on specific tools, frameworks, or libraries, and Syllabi generates curricula tailored to those ecosystems." },
    ...
    keywords: ["data science course generator", "ML curriculum builder", "AI data science training", "machine learning course creator"],
    emoji: "📊",
    category: "technology",
  },
  {
    ...
    metaDescription: "Create cybersecurity training courses with AI. Generate security awareness programs, ethical hacking curricula, and compliance training with Syllabi.",
    blurb: "Cybersecurity training is no longer optional. Syllabi generates comprehensive security courses — from employee awareness programs to advanced penetration testing curricula — with assessments that verify real understanding, not just checkbox completion.",
    ...
    keywords: ["cybersecurity course generator", "security training builder", "infosec curriculum creator", "security awareness course AI"],
    emoji: "🔒",
    category: "technology",
  },
  // ── Creative ─────────────────────────────────────────────────
  {
    ...
    blurb: "Your audience already trusts you. Now monetize that trust with a structured course. Syllabi takes your topic expertise and generates a complete course framework — so you can focus on recording content instead of planning curriculum.",
    useCases: ["YouTube → course pipeline", "Membership site course libraries", "Lead magnet mini-courses", "Workshop and cohort curricula"],
    faqs: [
  ...
  },
  {
    ...
    useCases: ["Self-paced coaching programs", "Group coaching curricula", "Certification programs", "Workshop series frameworks"],
    faqs: [
      ...
      { question: "How do I build a certification program?", answer: "Generate a comprehensive course with assessment milestones. Each module includes quizzes that serve as certification checkpoints. Export the full program as your official certification curriculum." },
    ...
    keywords: ["course generator for coaches", "coaching program builder", "consultant course creator", "online coaching curriculum AI"],
    emoji: "🎯",
    category: "creative",
  },
  // ── Health & Wellness ────────────────────────────────────────
  {
    ...
    metaDescription: "Yoga teachers: create structured training courses with AI. Build teacher training programs, workshop curricula, and student learning paths with Syllabi.",
    blurb: "Whether you're designing a 200-hour YTT program or a beginner workshop series, Syllabi generates structured yoga curricula with progressive sequencing, anatomy modules, philosophy lessons, and practical teaching components.",
    ...
    faqs: [
      { question: "Can it generate a full 200-hour YTT curriculum?", answer: "Yes. Specify '200-hour yoga teacher training' as your course topic and Syllabi generates a comprehensive curriculum covering asana, pranayama, anatomy, philosophy, and teaching methodology." },
      { question: "Does it cover different yoga styles?", answer: "Absolutely. Specify any style — Vinyasa, Hatha, Yin, Ashtanga, Kundalini, or Restorative — and the curriculum is tailored to that tradition's methodology." },
      { question: "Can I export for my yoga studio's website?", answer: "Yes. Use PDF export for downloadable program guides, Notion export for interactive online curricula, or shareable links for web-based access." },
    ],
    keywords: ["yoga course generator", "yoga teacher training curriculum", "yoga workshop builder", "YTT program creator"],
    emoji: "🧘",
    category: "health",
  },
  {
    ...
    metaDescription: "Fitness trainers: create educational courses for clients with AI. Generate nutrition, exercise science, and training methodology curricula with Syllabi.",
    ...
    useCases: ["Client education programs", "Personal trainer certification prep", "Nutrition fundamentals courses", "Specialty training curricula (strength, HIIT, mobility)"],
    faqs: [
    ...
    keywords: ["fitness course generator", "personal trainer curriculum builder", "fitness education course AI", "training program course creator"],
    emoji: "💪",
    category: "health",
  },
  {
    ...
    blurb: "Healthcare education demands structure and accuracy. Syllabi generates training frameworks for continuing medical education, staff onboarding, patient education programs, and clinical procedure training — saving your education team weeks of curriculum development.",
  ...
  },
  {
    ...
    metaDescription: "Create marketing training courses with AI. Build SEO, content marketing, social media, and analytics curricula for your team with Syllabi.",
    ...
    keywords: ["marketing training course generator", "SEO course builder", "marketing team training AI", "digital marketing curriculum creator"],
    emoji: "📣",
    category: "business",
  },
  {
    ...
    faqs: [
      ...
      { question: "Does it cover market-specific content?", answer: "Add your local market details in the context field. Syllabi will tailor the curriculum to reference your specific market dynamics and regulations." },
    ],
  ...
  // ── Language ──────────────────────────────────────────────────
  {
    ...
    metaDescription: "Language teachers: generate structured courses for any language with AI. Build curricula with progressive lessons, vocabulary modules, and assessments.",
    ...
    keywords: ["language course generator", "ESL curriculum builder", "language teaching AI", "foreign language course creator"],
    emoji: "🌍",
    category: "language",
  },
  {
    ...
    metaDescription: "ESL teachers: create structured English language courses with AI. Generate level-appropriate curricula with grammar, vocabulary, and speaking practice modules.",
    ...
    keywords: ["ESL course generator", "English teaching curriculum AI", "EFL course builder", "ESL lesson plan generator"],
    emoji: "🗣️",
    category: "language",
  },
  // ── More Niches ──────────────────────────────────────────────
  {
    ...
    blurb: "Nonprofits need to do more with less. Syllabi generates structured training programs for volunteer onboarding, community education, and grant-funded initiatives — so your team spends time on impact, not curriculum design.",
    ...
    faqs: [
      ...
      { question: "Can I demonstrate training deliverables for grants?", answer: "Yes. Generate complete training curricula and export as professionally formatted PDFs. These serve as excellent deliverables for grant applications and reporting." },
  ...
  },
  {
    ...
    metaDescription: "Online course creators: generate complete course structures with AI. Build Teachable, Thinkific, or Kajabi-ready curricula with modules, quizzes, and outlines.",
  ...
  },
  {
    ...
    keywords: ["life coaching course generator", "personal development curriculum AI", "coaching program builder", "transformation course creator"],
    emoji: "✨",
    category: "creative",
  },
  {
    ...
    tagline: "Structure your music lessons into progressive, professional curricula.",
    metaDescription: "Music teachers: create structured music courses with AI. Build progressive curricula for instruments, theory, and music production with Syllabi.",
    blurb: "Music education thrives on structure. Syllabi generates progressive music curricula — from beginner instrument courses to advanced music theory and production — with clear learning pathways and assessment milestones.",
    ...
    faqs: [
      { question: "Can I create instrument-specific courses?", answer: "Yes. Generate courses for piano, guitar, violin, drums, or any instrument. Specify the instrument and student level for a tailored progressive curriculum." },
      ...
      { question: "Can I create group class curricula?", answer: "Yes. Specify 'group class format' and Syllabi generates ensemble-friendly curricula with collaborative exercises and peer assessment components." },
    ],
    keywords: ["music course generator", "music teaching curriculum AI", "instrument course builder", "music theory course creator"],
    emoji: "🎵",
    category: "creative",
  },
  {
    ...
    faqs: [
      ...
      { question: "Can I use this for team workshops?", answer: "Yes. Generate workshop curricula with interactive and discussion-format lessons. Export to PPTX for slide-based facilitation." },
    ],
    keywords: ["product management course generator", "PM training builder AI", "product manager curriculum creator", "PM onboarding program"],
    emoji: "📋",
    category: "business",
  },
  {
    ...
    keywords: ["accounting course generator", "CPE course builder", "finance training AI", "accounting education curriculum"],
    emoji: "📒",
    category: "business",
  },
  {
    ...
    tagline: "Teach AI to your team — structured curricula from fundamentals to deployment.",
    ...
    faqs: [
      ...
      { question: "Does it cover the latest AI developments like LLMs?", answer: "Yes. Request courses on large language models, prompt engineering, RAG systems, or fine-tuning, and get structured curricula covering the latest approaches." },
    ...
    keywords: ["AI course generator", "machine learning curriculum builder", "AI training program creator", "LLM course generator"],
    emoji: "🤖",
    category: "technology",
  },
  {
    ...
    metaDescription: "Create project management training courses with AI. Generate PMP prep, Agile/Scrum training, and team development curricula with Syllabi.",
  ...
  },
  {
    ...
    tagline: "Create CLE courses and firm training programs without the curriculum committee.",
    ...
    blurb: "Law firms need structured training for associates, paralegals, and clients — but building curricula drains billable hours. Syllabi generates complete legal education programs covering practice areas, procedures, and professional development.",
    ...
    keywords: ["legal training course generator", "CLE course builder", "law firm training AI", "legal education curriculum creator"],
    emoji: "⚖️",
    category: "business",
  },
  {
    ...
    tagline: "Build structured Bible studies, leadership training, and small group curricula.",
    ...
    useCases: ["Bible study series", "New member orientation programs", "Small group discussion curricula", "Ministry leadership training"],
    faqs: [
      ...
      { question: "Does it work for youth ministry?", answer: "Absolutely. Specify the age group (teens, young adults, etc.) and Syllabi generates age-appropriate curricula with engaging formats and relatable applications." },
    ...
    keywords: ["church course generator", "Bible study curriculum builder", "ministry training AI", "church education program creator"],
    emoji: "⛪",
    category: "education",
  },
  {
