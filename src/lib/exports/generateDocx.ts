...
const STYLE_CONFIG: Record<TeachingStyle, DocxStyleConfig> = {
  conversational: {
    ...
    sectionWord: "Lesson",
    coverEyebrow: null,
    brandMark: "Generated by Syllabi",
    coverItalic: true,
  ...
  academic: {
    ...
    moduleWord: "Chapter",
    sectionWord: "Lesson",
    coverEyebrow: "A  S Y L L A B I   M O N O G R A P H",
    brandMark: "Syllabi · Academic Edition",
    coverItalic: false,
  ...
  "hands-on": {
    ...
    brandMark: "Syllabi · Workshop Edition",
    coverItalic: false,
  ...
  storytelling: {
    ...
    brandMark: "Syllabi · Stories Edition",
    coverItalic: true,
