                ...
                <tr>
                  <td width="50%" style="padding: 0 8px 16px 0; vertical-align: top;">
                    <div style="background: linear-gradient(135deg, #FAF5FF, #F3E8FF); border-radius: 16px; padding: 24px 20px; border: 1px solid #EDE9FE;">
                      ...
                      <p style="margin: 0; font-size: 13px; color: #6B7280; line-height: 1.5;">Full courses with modules, lessons, quizzes &amp; pacing — NotebookLM podcast export, design, and a shareable link included.</p>
                    </div>
                  </td>
