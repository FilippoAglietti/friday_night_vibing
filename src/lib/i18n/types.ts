...
export interface Translations {
  ...
  pricing: {
    ...
    redirecting: string;
    topPlanNote: string;
    billedPlannerAnnual: string;
    billedMasterclassAnnual: string;
    startProBtnAnnual: string;
    goProMaxBtnAnnual: string;
    ...
    ent4: string;
    ent5: string;
    enterpriseStrip: { eyebrow: string; heading: string; desc: string; cta: string };
    forever: string;
    month: string;
    oneTimeLabel: string;
    getStartedFree: string;
