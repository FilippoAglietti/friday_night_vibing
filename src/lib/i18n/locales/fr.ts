...
const fr: Translations = {
  ...
  pricing: {
    ...
    freeDesc: "1 cours gratuit par mois. Même qualité IA que les plans payants. Sans carte bancaire.",
    proDesc: "Pour les créateurs de cours qui publient sérieusement — les meilleures structures du marché, relues par Opus.",
    fivePackDesc: "5 générations premium. Sans abonnement.",
    proMaxDesc: "Des cours prêts à enseigner, peaufinés et exportables pour générer un podcast dans NotebookLM.",
    ...
    free1: "1 cours gratuit par mois",
    free2: "Modules, leçons et quiz",
    free3: "Export PDF et Notion",
    free4: "Liens de cours partageables",
    free5: "Export podcast NotebookLM",
    free6: "15 générations/mois (Planner)",
    pro1: "15 squelettes de cours relus par mois",
    pro2: "Détecteur d'hallucinations de qualité Opus",
    pro3: "Tous les formats (Crash · Short · Full · Masterclass)",
    pro4: "Déblocage de contenu à la demande à €5 par squelette",
    pro5: "Upgrade Single Masterclass à €10, à la demande",
    pm1: "20 cours Masterclass complets par mois",
    pm2: "Export prêt pour NotebookLM → transformez n'importe quel cours en podcast conversationnel",
    pm3: "Peaufinage stratégique d'Opus sur les leçons clés",
    pm4: "Cours de format Masterclass inclus",
    ...
    pack1: "5 générations Masterclass",
