...
const fr: Translations = {
  ...
  pricing: {
    ...
    bestForTeachers: "Idéal pour les enseignants",
    oneTime: "Paiement unique",
    bestValue: "Meilleur rapport qualité-prix",
    chipSkeleton: "Squelette",
    chipFullContent: "Contenu complet",
    upgradeEyebrow: "Passez au forfait supérieur",
    upgradeSubtitle: "Choisissez votre cycle de facturation et lancez vos cours avec l'IA.",
    launching: "Lancement demain",
    redirecting: "Redirection…",
    topPlanNote: "Vous êtes déjà sur le forfait le plus élevé. Contactez-nous à hello@syllabi.online si besoin.",
    billedPlannerAnnual: "facturé 290 €/an",
    billedMasterclassAnnual: "facturé 990 €/an",
    startProBtnAnnual: "Démarrer Planner — 24 €/mois annuel",
    goProMaxBtnAnnual: "Démarrer Masterclass — 82 €/mois annuel",
    enterpriseDesc: "White-label, SSO et support dédié pour les équipes de 10+.",
    ent1: "Générations illimitées",
    ent2: "SSO + provisionnement SCIM",
    ent3: "Success manager dédié",
    ent4: "Image de marque et domaine personnalisés",
    ent5: "SLA de support prioritaire",
    enterpriseStrip: {
      eyebrow: "Pour les équipes de 10+",
      heading: "Syllabi pour toute votre équipe ?",
      desc: "SSO, domaine white-label, provisionnement SCIM, success manager dédié.",
    ...
    pro2: "Modifiez dans le dashboard — changez n'importe quelle section",
