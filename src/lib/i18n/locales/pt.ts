...
const pt: Translations = {
  ...
  pricing: {
    ...
    save21: "Economize 21%",
    save13: "Economize 13%",
    freeDesc: "1 curso grátis por mês. A mesma qualidade de IA dos planos pagos. Sem cartão de crédito.",
    proDesc: "Para criadores de cursos que publicam de verdade — as melhores estruturas do mercado, revisadas por Opus.",
    fivePackDesc: "5 gerações premium. Sem assinatura.",
    proMaxDesc: "Cursos prontos para ensinar, polidos e exportáveis para gerar podcasts no NotebookLM.",
    ...
    free1: "1 curso grátis por mês",
    free2: "Módulos, aulas e quizzes",
    free3: "Exportação para PDF e Notion",
    free4: "Links compartilháveis de cursos",
    free5: "Exportação de podcast NotebookLM",
    free6: "15 gerações/mês (Planner)",
    pro1: "15 esqueletos de curso revisados por mês",
    pro2: "Detector de alucinações com qualidade Opus",
    pro3: "Todos os formatos (Crash · Short · Full · Masterclass)",
    pro4: "Desbloqueio de conteúdo on-demand por €5 por esqueleto",
    pro5: "Upgrade para Single Masterclass por €10, on-demand",
    pm1: "20 cursos Masterclass completos por mês",
    pm2: "Exportação pronta para NotebookLM → transforme qualquer curso em podcast conversacional",
    pm3: "Polimento estratégico do Opus nas aulas principais",
    pm4: "Cursos no formato Masterclass inclusos",
