...
const pt: Translations = {
  ...
  pricing: {
    ...
    bestForTeachers: "Ideal para professores",
    oneTime: "Pagamento Único",
    bestValue: "Melhor Custo-Benefício",
    chipSkeleton: "Esqueleto",
    chipFullContent: "Conteúdo Completo",
    upgradeEyebrow: "Atualize o seu plano",
    upgradeSubtitle: "Escolha o seu ciclo de faturação e comece a publicar cursos com IA.",
    launching: "Lançamento amanhã",
    redirecting: "A redirecionar…",
    topPlanNote: "Você já está no plano mais alto. Fale conosco em hello@syllabi.online se precisar de algo.",
    billedPlannerAnnual: "faturado €290/ano",
    billedMasterclassAnnual: "faturado €990/ano",
    startProBtnAnnual: "Começar Planner — €24/mês anual",
    goProMaxBtnAnnual: "Começar Masterclass — €82/mês anual",
    enterpriseDesc: "White-label, SSO e suporte dedicado para equipes de 10+.",
    ent1: "Gerações ilimitadas",
    ent2: "SSO + provisionamento SCIM",
    ent3: "Success manager dedicado",
    ent4: "Marca e domínio personalizados",
    ent5: "SLA de suporte prioritário",
    enterpriseStrip: {
      eyebrow: "Para equipes de 10+",
      heading: "Precisa do Syllabi para toda a sua equipe?",
      desc: "SSO, domínio white-label, provisionamento SCIM, success manager dedicado.",
