...
const en: Translations = {
  ...
  pricing: {
    ...
    save21: "Save 21%",
    save13: "Save 13%",
    freeDesc: "1 free course per month. Same AI quality as paid plans. No card required.",
    proDesc: "For course creators who ship regularly — the best course structures in the market, reviewed by Opus.",
    fivePackDesc: "5 premium generations. No subscription.",
    proMaxDesc: "Ready-to-teach courses, polished and exportable for NotebookLM podcast generation.",
    ...
    free1: "1 free course per month",
    free2: "Modules, lessons & quizzes",
    free3: "PDF & Notion export",
    free4: "Shareable course links",
    free5: "NotebookLM podcast export",
    free6: "15 generations/month (Planner)",
    pro1: "15 reviewed course skeletons per month",
    pro2: "Opus-quality hallucination catcher",
    pro3: "All lengths (Crash · Short · Full · Masterclass)",
    pro4: "€5 on-demand body unlock per skeleton",
    pro5: "€10 Single Masterclass upgrade, on-demand",
    pm1: "20 full Masterclass courses per month",
    pm2: "NotebookLM-ready export → turn any course into a conversational podcast",
    pm3: "Opus strategic polish on key lessons",
    pm4: "Masterclass-length courses included",
    ...
    pack1: "5 Masterclass generations",
