...
const tr: Translations = {
  ...
  pricing: {
    ...
    bestForTeachers: "Öğretmenler için ideal",
    oneTime: "Tek Seferlik",
    bestValue: "En İyi Değer",
    chipSkeleton: "İskelet",
    chipFullContent: "Tam İçerik",
    upgradeEyebrow: "Planınızı yükseltin",
    upgradeSubtitle: "Fatura döngünüzü seçin ve yapay zeka ile kurs yayınlamaya başlayın.",
    launching: "Yarın çıkıyor",
    redirecting: "Yönlendiriliyor…",
    topPlanNote: "Zaten en yüksek plandasınız. Bir şeye ihtiyacınız olursa hello@syllabi.online adresinden bize ulaşın.",
    billedPlannerAnnual: "yıllık €290 faturalanır",
    billedMasterclassAnnual: "yıllık €990 faturalanır",
    startProBtnAnnual: "Planner'a Başla — yıllık €24/ay",
    goProMaxBtnAnnual: "Masterclass'a Başla — yıllık €82/ay",
    enterpriseDesc: "10+ kişilik ekipler için white-label, SSO ve özel destek.",
    ent1: "Sınırsız üretim",
    ent2: "SSO + SCIM sağlama",
    ent3: "Özel success manager",
    ent4: "Özel marka ve alan adı",
    ent5: "Öncelikli destek SLA'sı",
    enterpriseStrip: {
      eyebrow: "10+ kişilik ekipler için",
      heading: "Syllabi'ye tüm ekibiniz için mi ihtiyacınız var?",
      desc: "SSO, white-label alan adı, SCIM sağlama, özel success manager.",
    ...
    save21: "%21 Tasarruf",
    save13: "%13 Tasarruf",
    freeDesc: "Ayda 1 ücretsiz AI kurs iskeleti. Dashboard'da düzenle, her yere dışa aktar, herkese açık bağlantıyla paylaş. Kredi kartı gerekmez.",
    proDesc: "Her hafta yayın yapan üreticiler için. Ayda 15 iskelet — dashboard'da düzenle, istediğin her yere yeniden dışa aktar, herkese açık bağlantıyla paylaş. Tam bölüm içeriğini talep üzerine aç.",
    fivePackDesc: "Bölüm içeriğiyle 5 tam kurs. Dashboard'da düzenle, herhangi bir formata yeniden dışa aktar, herkese açık bağlantıyla paylaş. Abonelik yok.",
    proMaxDesc: "Her ay tam bölüm içeriğiyle öğretmeye hazır 20 kurs. Düzenle, her formata yeniden dışa aktar, özenli bir bağlantıyla paylaş — ya da herhangi bir kursu NotebookLM podcast'ine dönüştür.",
    ...
    free1: "Ayda 1 kurs iskeleti",
    free2: "Modüller, dersler ve quizler — tamamen düzenlenebilir",
    free3: "PDF, Notion ve Markdown'a dışa aktarma",
    free4: "Herkese açık paylaşım bağlantısı — tasarımlı, metin yığını değil",
    ...
    pro6: "€5 tam içerik açma · €10 Masterclass yükseltmesi, talep üzerine",
    pm1: "Ayda 20 tam kurs — bölüm içeriği dahil",
    pm2: "NotebookLM için hazır podcast dışa aktarma",
    pm3: "Dashboard'da düzenle ve yeniden dışa aktar: PDF · Notion · PPTX · DOCX · Markdown",
    pm4: "Herkese açık paylaşım bağlantısı — izleyiciniz için giriş gerekmez",
    ...
    pack1: "5 tam kurs — bölüm içeriği dahil",
    pack2: "NotebookLM için hazır podcast dışa aktarma",
    pack3: "Tüm formatlar: PDF · Notion · PPTX · DOCX · Markdown",
    pack4: "White-label — Syllabi markası olmadan",
    pack5: "Dashboard'da düzenle ve yeniden dışa aktar, sınırsız",
    pack6: "Kurs başına herkese açık paylaşım bağlantısı",
