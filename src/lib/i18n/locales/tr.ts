...
const tr: Translations = {
  ...
  tutorial: {
    backToHome: "Ana sayfaya dön",
    badge: "Adım adım rehber",
    heading: "İlk Kursunuzu Nasıl Oluşturursunuz",
    subheading: "Fikirden paylaşılabilir bağlantıya 60 saniyeden kısa sürede.",
    step1Title: "Bir şablon seçin",
    step1Desc: "Kullanım durumunuza uygun bir şablonla başlayın.",
    step2Title: "Kursunuzu tanımlayın",
    step2Desc: "Konunuzu, hedef kitlenizi ve tercih ettiğiniz stili girin.",
    step3Title: "Oluşturun ve inceleyin",
    step3Desc: "Oluştur'a basın. Saniyeler içinde tam bir kursunuz olacak.",
    step4Title: "Düzenleyin ve özelleştirin",
    step4Desc: "Herhangi bir bölümü düzenlemek için Kurs Editörünü kullanın.",
    step5Title: "Paylaşın veya dışa aktarın",
    step5Desc: "Paylaşılabilir bağlantınızı kopyalayın, PDF veya Notion'a aktarın.",
    tipsTitle: "Pro İpuçları",
    tip1: "Daha hedefli içerik için bir niş ekleyin.",
    tip2: "Podcast tarzı dersler için Pro Max'teki ses özelliğini kullanın.",
    tip3: "Mini kursları potansiyel müşteri mıknatısına dönüştürün.",
