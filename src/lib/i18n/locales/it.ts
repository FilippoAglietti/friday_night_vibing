...
const it: Translations = {
  ...
  pricing: {
    ...
    save21: "Risparmia 21%",
    save13: "Risparmia 13%",
    freeDesc: "1 corso gratis al mese. Stessa qualità AI dei piani a pagamento. Nessuna carta richiesta.",
    ...
    proMaxDesc: "Corsi pronti da insegnare, rifiniti ed esportabili per NotebookLM.",
    ...
    free1: "1 corso gratis al mese",
    free2: "Moduli, lezioni e quiz",
    free3: "Esportazione PDF e Notion",
    free4: "Link corso condivisibili",
    free5: "Esportazione podcast NotebookLM",
    free6: "15 generazioni/mese (Planner)",
    pro1: "15 scheletri di corso revisionati al mese",
    pro2: "Acchiappa-allucinazioni di qualità Opus",
    pro3: "Tutte le lunghezze (Crash · Short · Full · Masterclass)",
    pro4: "Sblocco contenuti on-demand a €5 per scheletro",
    pro5: "Upgrade a Single Masterclass a €10, on-demand",
    pm1: "20 corsi Masterclass completi al mese",
    pm2: "Export pronto per NotebookLM → trasforma ogni corso in un podcast conversazionale",
    pm3: "Rifinitura strategica Opus sulle lezioni chiave",
    pm4: "Corsi di lunghezza Masterclass inclusi",
    pm5: "Export white-label (senza brand Syllabi)",
    pm6: "Coda di generazione prioritaria",
    pm7: "Tutti i formati di export (PDF, Markdown, Notion, NotebookLM)",
    pack1: "5 generazioni Masterclass",
