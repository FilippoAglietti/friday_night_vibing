...
const de: Translations = {
  ...
  pricing: {
    ...
    save21: "21 % sparen",
    save13: "13 % sparen",
    freeDesc: "1 kostenloser Kurs pro Monat. Gleiche KI-Qualität wie in den Bezahlplänen. Keine Kreditkarte erforderlich.",
    proDesc: "Für Kursersteller, die ernsthaft liefern — die besten Kursstrukturen am Markt, geprüft von Opus.",
    fivePackDesc: "5 Premium-Generierungen. Kein Abonnement.",
    proMaxDesc: "Unterrichtsfertige Kurse, fein poliert und exportierbar für Podcasts via NotebookLM.",
    ...
    free1: "1 kostenloser Kurs pro Monat",
    free2: "Module, Lektionen & Quizzes",
    free3: "PDF- & Notion-Export",
    free4: "Teilbare Kurs-Links",
    free5: "NotebookLM-Podcast-Export",
    free6: "15 Generierungen/Monat (Planner)",
    pro1: "15 geprüfte Kurs-Skelette pro Monat",
    pro2: "Halluzinations-Fänger in Opus-Qualität",
    pro3: "Alle Längen (Crash · Short · Full · Masterclass)",
    pro4: "On-Demand-Freischaltung für €5 pro Skelett",
    pro5: "€10 Single-Masterclass-Upgrade, on demand",
    pm1: "20 vollständige Masterclass-Kurse pro Monat",
    pm2: "NotebookLM-fertiger Export → aus jedem Kurs einen Gesprächs-Podcast machen",
    pm3: "Strategischer Opus-Feinschliff auf Schlüssellektionen",
    pm4: "Kurse in Masterclass-Länge inklusive",
    ...
    pack1: "5 Masterclass-Generierungen",
