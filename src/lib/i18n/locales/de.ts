...
const de: Translations = {
  ...
  pricing: {
    ...
    bestForTeachers: "Ideal für Lehrende",
    oneTime: "Einmalig",
    bestValue: "Bestes Preis-Leistungs-Verhältnis",
    chipSkeleton: "Gerüst",
    chipFullContent: "Voller Inhalt",
    upgradeEyebrow: "Tarif upgraden",
    upgradeSubtitle: "Wählen Sie Ihren Abrechnungszyklus und veröffentlichen Sie Kurse mit KI.",
    launching: "Start morgen",
    redirecting: "Weiterleitung…",
    topPlanNote: "Sie sind bereits im höchsten Tarif. Kontaktieren Sie uns unter hello@syllabi.online, wenn Sie etwas brauchen.",
    billedPlannerAnnual: "abgerechnet mit 290 €/Jahr",
    billedMasterclassAnnual: "abgerechnet mit 990 €/Jahr",
    startProBtnAnnual: "Planner starten — 24 €/Monat jährlich",
    goProMaxBtnAnnual: "Masterclass starten — 82 €/Monat jährlich",
    enterpriseDesc: "White-Label, SSO und dedizierter Support für Teams ab 10 Personen.",
    ent1: "Unbegrenzte Generierungen",
    ent2: "SSO + SCIM-Provisioning",
    ent3: "Dedizierter Success Manager",
    ent4: "Eigenes Branding & Domain",
    ent5: "Priorisiertes Support-SLA",
    enterpriseStrip: {
      eyebrow: "Für Teams ab 10 Personen",
      heading: "Syllabi für Ihr ganzes Team?",
      desc: "SSO, White-Label-Domain, SCIM-Provisioning, dedizierter Success Manager.",
