...
const nl: Translations = {
  ...
  tutorial: {
    ...
    step1Desc: "Begin met een template dat past bij jouw gebruik, of ga volledig op maat.",
    step2Title: "Beschrijf je cursus",
    step2Desc: "Voer je onderwerp, doelgroep en voorkeursstijl in.",
    step3Title: "Genereer en bekijk",
    step3Desc: "Klik op Genereren. In seconden heb je een complete cursus.",
    step4Title: "Bewerk en pas aan",
    step4Desc: "Gebruik de Course Editor om elke sectie aan te passen.",
    step5Title: "Deel of exporteer",
    step5Desc: "Kopieer je deelbare link, exporteer naar PDF of Notion.",
    tipsTitle: "Pro-tips",
    tip1: "Voeg een niche toe voor gerichtere inhoud.",
    tip2: "Gebruik de audiofunctie op Pro Max voor podcastachtige lessen.",
    tip3: "Zet mini-cursussen om in lead magnets.",
