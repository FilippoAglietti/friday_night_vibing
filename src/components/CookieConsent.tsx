  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <div className="mx-auto max-w-2xl rounded-2xl border border-violet-500/20 bg-gradient-to-r from-violet-950/40 to-purple-950/40 px-4 py-4 md:px-6 md:py-5 shadow-2xl backdrop-blur-xl md:flex md:items-center md:justify-between md:gap-6">
            {/* Text content */}
