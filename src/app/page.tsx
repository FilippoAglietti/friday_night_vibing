  ...
  return (
    ...
    >
      ...
      <main>
        ...
        <section
          id="hero"
          className="snap-section relative flex min-h-[100dvh] flex-col items-center justify-center px-4 pt-20 pb-10 md:pt-16 md:pb-16"
        >
        ...
        <section
          id="problem-solution"
          className="snap-section relative flex min-h-[100dvh] flex-col items-center justify-center px-4 py-12 md:py-20"
        >
        ...
        {/* ═══════════════════════════════════════════════════
            HOW IT WORKS
        ═══════════════════════════════════════════════════ */}
        <section id="how-it-works" className="snap-section relative flex min-h-[100dvh] flex-col items-center justify-center px-4 py-12 md:py-20">
          {/* Section-specific accent */}
          <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <section
          id="generate"
          className={`${curriculum || isGenerating ? "" : "snap-section"} relative min-h-[100dvh] flex flex-col px-4 py-8 md:py-16 ${
        ...
        ═══════════════════════════════════════════════════ */}
        <section id="examples" className="snap-section relative flex min-h-[100dvh] flex-col items-center justify-center px-4 py-12 md:py-20">
          {/* Section-specific accent */}
          <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        {/* ═══════════════════════════════════════════════════
            PRICING
        ═══════════════════════════════════════════════════ */}
        <section id="pricing" className="snap-section relative flex min-h-[100dvh] flex-col items-center justify-center px-4 py-12 md:py-20">
          {/* Section-specific accent */}
          <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        {/* ═══════════════════════════════════════════════════
            FINAL CTA
        ═══════════════════════════════════════════════════ */}
        <section id="final-cta" className="snap-section relative flex min-h-[100dvh] flex-col items-center justify-center px-4 py-12 md:py-20">
          {/* Section-specific accent */}
          <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
